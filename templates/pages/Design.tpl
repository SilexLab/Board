...
<div class="container">
	<article class="post">
		<div class="container_head">
			<div class="post_time">Heute, 10:25</div>
			<div class="post_num">#1</div>
		</div>
		<div class="container_content">
			<div class="post_container user_online"> 
				<div class="post_user_info">
					<div class="post_user_info_content">
						...
						<div class="user_rank">
							<small>Administrösität</small>
						</div>
						<div class="user_posts">
							<strong>Beiträge:</strong> 42
						</div>
						<div class="user_flair">
							<strong>Flair:</strong> +23
						</div>
					</div>
				</div>
		...
		<div class="container_post_flair">
			<div class="post_flair_background">
				<div class="post_flair" style="width: 80%;"></div>
			</div>
		</div>
	...
	<article class="post">
		<div class="container_head">
			<div class="post_time">Heute, 10:26</div>
			...
			<div class="post_container"> 
				<div class="post_user_info">
					<div class="post_user_info_content">
						...
						<div class="user_rank">
							<small>Webdings</small>
						</div>
						<div class="user_posts">
							<strong>Beiträge:</strong> 13
						</div>
						<div class="user_flair">
							<strong>Flair:</strong> +46
						</div>
					</div>
				</div>
				<div class="post_content">
		...
		<div class="container_post_flair">
			<div class="post_flair_background">
				<div class="post_flair" style="width: 90%;"></div>
			</div>
		</div>
		<div class="container_footer">
			<div class="button_bar_left">
			...
			<div class="post_container"> 
				<div class="post_user_info">
					<div class="post_user_info_content">
						...
						<div class="user_rank">
							<small>PHP-Baus</small>
						</div>
						<div class="user_posts">
							<strong>Beiträge:</strong> 42
						</div>
						<div class="user_flair">
							<strong>Flair:</strong> -1337
						</div>
					</div>
				</div>
				<div class="post_content">
					<div class="post_message">
						...
						würde cadi jetzt sagen, würde noxi jetzt sagen
					</div>
					<div class="post_signature">
						Signatur des Posterstellers
					</div>
...
<div class="container">
	...
	<div class="container_content" style="min-height: 100px;">
	</div>
	<div class="container_footer">
	</div>
</div>
