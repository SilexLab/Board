					...
					<form method="post">
						...
						<input type="submit" name="Register" value="{{ lang=sbb.form.submit }}" />
					</form>
                    <p>{{ Message }}</p>
                	</div>