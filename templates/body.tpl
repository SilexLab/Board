<body>
    ...
    <nav class="Menu">
    	<div class="Size">
        	<ul class="MenuList">
            	<li class="active"><a href="./" title="Forum"><div>Forum</div></a></li>
            ...
            <div class="SearchForm">
            	<form method="GET" accept-charset="utf-8" action="">
                	<input title="Suche" type="search" value="" placeholder="Suche..." name="Search" id="Search" pattern=".+" required><input type="submit" id="SearchSubmit" value="S">
                </form>
            </div>
    	</div>
    </nav>
