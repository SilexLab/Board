...
--
-- Host: localhost
-- Erstellungszeit: 01. Okt 2011 um 23:09
...
INSERT INTO `session` (`ID`, `UserID`, `Username`, `IPAddress`, `UserAgent`, `LastActivityTime`, `Token`, `LoginHash`) VALUES
(0, 1, '', '127.0.0.1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/535.1 (KHTML, like Gecko) Chrome/14.0.835.126 Safari/535.1', 1315238793, '50534dfda1332ccdcea623b40401a3677fb6a717', '');
