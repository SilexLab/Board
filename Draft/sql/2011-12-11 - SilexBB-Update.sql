...
--
-- Host: localhost
-- Erstellungszeit: 11. Dez 2011 um 15:57
...
CREATE TABLE IF NOT EXISTS `config` (
  `Module` varchar(32) NOT NULL DEFAULT 'sbb.core',
...
INSERT INTO `config` (`Module`, `ConfigNode`, `CategoryNode`, `ConfigValue`, `TemplateVariable`) VALUES
('sbb.core', 'config.page.title', 'config.page', 'Silex Bulletin Board', 'PageTitle'),
('sbb.core', 'config.style.default', 'config.style', 'Standard', NULL);
